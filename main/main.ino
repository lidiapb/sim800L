...
// Minimum time between consecutive irrigations in seconds for valve
...
// Effective irrigation time in seconds for valve
...
// Commands to request a manual irrigation (similar to pressing the button)
